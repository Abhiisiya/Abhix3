...
\033[1;31m.LIFE LINE :  ABHI SIYA -XD
...
def pas():
    print('\033[1;35m' + '---------------------------------------------------')
    password = input("➣ 𝐓𝐇𝐈𝐒 𝐈𝐒 𝐓00𝐋 𝐌𝐀𝐃𝐄 𝐁𝐘 :  𝐀𝐁𝐇𝐈 𝐒𝐈𝐘𝐀 - 𝐗𝐃.                               ----------------------------------------------------                   ➣  𝐁𝐄𝐓𝐀 𝐓00𝐋 𝐔𝐒𝐄 𝐊𝐀𝐑𝐍𝐀 𝐇𝐀𝐈 𝐓0 𝐀𝐁𝐇𝐈𝐈 𝐒𝐄 𝐏𝐀𝐒𝐒𝐖0𝐑𝐃 𝐋𝐀 𝐀𝐔𝐑 𝐃𝐀𝐋           -----------------------------------------------------------            ➣ 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂0𝐍𝐓𝐄𝐂𝐓 :  +91 8949323859                                  ----------------------------------------------------                   ➣ 𝐓00𝐋 𝐏𝐚𝐬𝐬𝐰𝐨𝐫𝐝 : ") 
    print('--------------------------------------------')
